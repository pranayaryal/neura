<template>
    <div class="container">
        ...
        <section class="section" v-if="!plotShown">
            <button @click="showScatterPlot" class="button is-info">Show plot</button>
        </section>
        <section class="section" id="plotSection">
        </section>
    ...
    export default {
        ...
        methods: {
            showScatterPlot() {
                ...
                const csvToParse = this.loadCsv();


                var parsed = d3.csvParse(csvToParse)
            ...
            loadCsv() {
               return 'CerealName,Manufacturer,Type,Calories,Protein,Fat,Sodium,DietaryFiber,Carbs,Sugars,Display Shelf,Potassium,VitaminsMinerals,ServingSizeWeight,CupsPerServing\n' +
